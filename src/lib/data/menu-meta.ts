...
export const STR = {
  en: {
    ...
    chefSection: "Chef's Suggestions",
    pairWith: "Pair it with",
    favs: "My Picks",
    favsEmpty: "Tap the heart on any dish to save it here.",
    favsHint: "Ready to order? Show this list to your server.",
    favAdd: "Save dish",
    favRemove: "Remove from my picks",
  ...
  es: {
    ...
    chefSection: "Sugerencias del Chef",
    pairWith: "Acompáñalo con",
    favs: "Mis Platos",
    favsEmpty: "Toca el corazón en un plato para guardarlo aquí.",
    favsHint: "¿Listos para ordenar? Muéstrale esta lista a tu mesero.",
    favAdd: "Guardar plato",
    favRemove: "Quitar de mis platos",
